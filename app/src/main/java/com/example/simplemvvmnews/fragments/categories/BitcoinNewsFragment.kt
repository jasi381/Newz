...
import com.example.simplemvvmnews.databinding.FragmentBitcoinNewsBinding
import com.example.simplemvvmnews.viewModel.NewsViewModel


class BitcoinNewsFragment:Fragment() {

    private lateinit var binding: FragmentBitcoinNewsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBitcoinNewsBinding.inflate(layoutInflater)
