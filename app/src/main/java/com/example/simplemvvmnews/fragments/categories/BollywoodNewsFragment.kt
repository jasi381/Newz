...
import com.example.simplemvvmnews.databinding.FragmentBollywoodNewsBinding
import com.example.simplemvvmnews.viewModel.NewsViewModel

class BollywoodNewsFragment:Fragment() {
    private lateinit var binding: FragmentBollywoodNewsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBollywoodNewsBinding.inflate(layoutInflater)

        val viewModel = ViewModelProvider(this)[NewsViewModel::class.java]

        viewModel.getNews("bollywood",  currentDate)
